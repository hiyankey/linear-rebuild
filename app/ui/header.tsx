    ...
    <header className="fixed top-0 left-0 h-[var(--header-height)] w-full border-white/8 border-b bg-transparent backdrop-blur-sm">
      <Container className="flex h-full md:items-center">
        ...
        >
          <nav
            className={cx(
              'fixed top-[var(--header-height)] left-0 h-[calc(100vh-var(--header-height))] w-full bg-background transition-opacity duration-500 ease-in md:relative md:top-0 md:block md:h-full md:w-auto md:translate-x-0 md:bg-transparent md:opacity-100',
              menuIsOpen
          ...
          >
            <ul
              className={cx(
                ...
                '[&_li]:h-auto [&_li]:transition-transform md:[&_li]:nth-[3]:hidden md:[&_li]:nth-[4]:hidden md:[&_li]:nth-[5]:hidden md:[&_li]:translate-y-0 md:[&_li]:transition-none lg:[&_li]:nth-[3]:block lg:[&_li]:nth-[4]:block lg:[&_li]:nth-[5]:block',
                ...
                menuIsOpen ? '[&_li]:translate-y-0' : '[&_li]:translate-y-8'
              )}
            >
